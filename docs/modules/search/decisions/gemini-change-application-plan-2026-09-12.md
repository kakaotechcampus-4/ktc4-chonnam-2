...
> **2026-09-18 갱신:** 운영 기본값은 `gemini-3.8-flash`로 전환됐고 모든 호출은 프록시를
> 경유한다(Owner 결정). §1·§8·Phase 3의 "3.8은 A/B 뒤" 항목은 **운영 기본값에 한해**
> 대체된다. 실험·계측 계획 자체는 이 문서대로 유효하다.
> → `gemini-3.8-proxy-baseline-2026-09-18.md`
...
현재 실측 결과는 Coarse / Fine 영상 탐침 실험 총정리를 기준으로 한다.
> 
...
| --- | --- | --- | --- |
| Gemini 3.7 / 3.8 Flash | 3.75 | $0.277 | $0.554 |
| Gemini 3.5 Flash-Lite | 2.50 | $0.119 | $0.119 |
| Gemini 3.1 Flash-Lite | 1.50 | $0.094 | $0.094 |
...
| 우선순위 | 대상 | 필요한 변경 |
| --- | --- | --- |
| P0 | `coarse_probe.py` | `--processing static |
...
- Gemini 3.8 Flash / agentic 조사 기록
- Coarse / Fine 단계별 설정과 구현 참고
- 제품 저장소 적용 대상 조사
- Coarse Probe Report
- Fine Probe Report
- Fine Probe 사람 검토 기록
...
- Gemini 최신 모델 문서
- Gemini 3.8 Flash 모델 문서
- Interactions API Video Understanding
- Gemini 3.8 Flash 발표
