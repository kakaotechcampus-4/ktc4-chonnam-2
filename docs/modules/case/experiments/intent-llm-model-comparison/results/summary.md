...
judge_run_id: `20260919T170342Z` — 이 채점 결과의 raw 파일은 `predictions/<model>/<case_id>.judge.20260919T170342Z.json`에 있다(필드별 판정 근거는 여기서 직접 읽는다).

| model | schema 준수율 | field 정확도 | hallucination rate | missed rate | 평균 latency(ms) | 총 비용(KRW) | 실패 케이스 | judge 실패 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| claude-haiku-4-5 | 100% | 95% | 0% | 2% | 3417 | 34.21 | 0/7 | 0 |
| gemini-3.1-flash-lite | 100% | 93% | 2% | 0% | 2676 | 2.38 | 0/7 | 0 |
| gpt-5-nano | 100% | 100% | 0% | 0% | 12745 | 8.34 | 0/7 | 0 |

## 필드별 정확도

| model | time_hint | vehicle_hint | situation_hint | location_hint | correction_target | confidence |
| --- | --- | --- | --- | --- | --- | --- |
| claude-haiku-4-5 | 100% | 100% | 100% | 86% | 100% | 86% |
| gemini-3.1-flash-lite | 100% | 86% | 100% | 100% | 100% | 71% |
| gpt-5-nano | 100% | 100% | 100% | 100% | 100% | 100% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| claude-haiku-4-5 | 100% | 100% | 100% | 67% | 100% | 100% | 100% |
| gemini-3.1-flash-lite | 100% | 100% | 100% | 83% | 67% | 100% | 100% |
| gpt-5-nano | 100% | 100% | 100% | 100% | 100% | 100% | 100% |
