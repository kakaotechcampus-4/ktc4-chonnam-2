...
>
> 해야 할 일은 **`second-completion-checklist.md`**에 모았다. 1차 항목을 고쳐 쓰지 않고 2차에서 다시 판정한다.
...
Mock Pack v5 기준으로 해야 할 일은 **`second-completion-checklist.md`**에 있다. 1차 항목을 고쳐 쓰지 않고 그 문서에서 다시 판정한다.
